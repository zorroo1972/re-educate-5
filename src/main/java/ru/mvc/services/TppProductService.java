...
public class TppProductService {
   ...
   ;
    ...
    public static ResponseEntity<?> getTppProductResponse(Long productId, List<Long> registrIdList) {
    ...
    public ResponseEntity<?> process(TppProductRequest tppProductRequest) throws CheckProductException, CheckAgreementException, CheckProductClassException, CheckRegisterTypeException, CheckRegisterException, CheckRegisterTypeExceptionEx {
        ...
        if (tppProductRequest.getInstanceId() == null || tppProductRequest.getInstanceId().toString().isBlank()) {
            ...
            responseEntity = getTppProductResponse(Long.valueOf(product.getId()),registrIdList);
            }
